...
export function FlightDetailPage() {
  ...
  return (
    <Layout
      ...
      hideNav
      headerRight={
        <button onClick={() => flight.trip_id ? navigate(`/trips/${flight.trip_id}`) : navigate(-1)} className="text-slate-400 hover:text-white p-3 -mr-3 flex items-center justify-center">
