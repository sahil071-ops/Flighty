...
/** Returns 'today', 'tomorrow', 'in N days' based on IST date */
...
export function ThisWeekBanner() {
  ...
  // One entry per member (earliest flight per member)
  ...
  return (
    <div className="bg-sky-900/40 border border-sky-700/50 rounded-xl px-4 py-3 flex items-center gap-3">
      <svg className="w-4 h-4 text-sky-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
        <path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" />
      </svg>
      <p className="text-sm text-sky-300">{text}</p>
    </div>
  );
}
